                ...
                <section>
                    ...
                    <div className="mt-6 border-y border-white/10 py-4">
                        <dl className="space-y-3">
                            ...
                            <div className="flex items-center justify-between gap-4">
                                <dt className="text-sm text-zinc-400 sm:text-base">MOTM awards</dt>
                                <dd className="text-xl font-semibold text-amber-400 sm:text-2xl">
                                    {motmWins}
                                </dd>
                            </div>
                            <div className="flex items-start justify-between gap-4">
                                <dt className="pt-1 text-sm text-zinc-400 sm:text-base">Top scorer months</dt>
                                <dd className="flex max-w-[60%] flex-wrap justify-end gap-1.5">
                                    {player.topScorerMonths?.length ? (
                                        player.topScorerMonths.map((month) => (
                                            <span
                                                className="rounded-full border border-amber-300/20 bg-amber-400/10 px-2.5 py-1 text-xs font-semibold text-amber-300 sm:text-sm"
                                                key={month}
                                            >
                                                {month}
                                            </span>
                                        ...
                                        <span className="pt-1 text-sm text-zinc-600">—</span>
                                    )}
                                </dd>
                            </div>
                        </dl>
